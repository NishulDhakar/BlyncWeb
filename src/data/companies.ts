...
export const COMPANIES: readonly CompanyEntry[] = [
  ...
  },
  {
    ...
    name: "Capgemini",
    region: "india",
    assessmentLabel: "Game-Based Aptitude",
    games: ["GeoStudio", "Spacio", "Switch Challenge", "Motion Challenge"],
  ...
  },
  {
    ...
    name: "Cognizant",
    region: "india",
    assessmentLabel: "GenC Game-Based Test",
    games: ["Switch Challenge", "Digit Challenge", "Grid Challenge", "Motion Challenge", "Deductive Challenge"],
