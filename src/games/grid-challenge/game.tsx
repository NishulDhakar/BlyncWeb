...
import GridChallengeUI, { type GridPhase } from './ui';
import {
  generateDots,
...
// initial state below is deliberately identical to what handleStart used to
// produce for a fresh run.
  ...
  return (
    <Container>
      <GamePage
        ...
        level={state.phase === 'results' ? 1 : state.level}
        timer={timerLabel}
      >
        <GridChallengeUI
          phase={state.phase}
