...
export default function CapgeminiGuidePageContent() {
    return (
                        ...
                        <div className="space-y-8 text-muted-foreground">
                            ...
                            <section>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="pl-6 border-l-4 border-primary">
                                        <h3 className="text-xl font-bold text-foreground mb-2">Week 3: Speed & Refinement</h3>
                                        <ul className="list-disc pl-6 space-y-1">
                                            <li>Increase time pressure—aim for test-like conditions</li>
                                            <li>Perform timed practice sessions of 15-20 minutes per game</li>
                                            <li>Identify and eliminate common mistakes</li>
                                            <li>Focus on speed without sacrificing accuracy</li>
                                            <li>Expected improvement: 40-50% from baseline</li>
                                        </ul>
                                    </div>

                                    <div className="pl-6 border-l-4 border-primary">
                                        <h3 className="text-xl font-bold text-foreground mb-2">Week 4: Final Prep & Tests</h3>
                                        <ul className="list-disc pl-6 space-y-1">
                                            <li>Take full-length practice tests simulating the actual assessment</li>
                                            <li>Review performance and identify remaining weak areas</li>
                                            <li>Mental preparation and stress management strategies</li>
                                            <li>Light practice on the day before to keep skills sharp</li>
                                            <li>Expected improvement: 50-70% from baseline (or more!)</li>
                                        </ul>
                                    </div>
                                </div>
                            </section>
                            ...
                            <section>
                                ...
                                <div className="space-y-4">
                                    <div className="p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                                        <p className="font-semibold text-foreground mb-2">1. Skipping the Practice Phase</p>
                                        <p>Some students try to optimize too early without building foundational skills. You can't develop speed without first understanding the mechanics thoroughly. Spend Week 1 building a strong foundation.</p>
                                    </div>

                                    <div className="p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                                        <p className="font-semibold text-foreground mb-2">2. Overemphasis on Speed</p>
                                        <p>While time pressure is important, accuracy matters more. A 70% score in 15 seconds is worse than a 90% score in 25 seconds. Balance is key—develop accuracy first, then speed.</p>
                                    </div>

                                    <div className="p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                                        <p className="font-semibold text-foreground mb-2">3. Not Reviewing Mistakes</p>
                                        <p>Every wrong answer is a learning opportunity. After each practice session, analyze what went wrong. Did you misunderstand the rules? Rush? Get confused? Identifying patterns in your mistakes prevents repeating them.</p>
                                    </div>
